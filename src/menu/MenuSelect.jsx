...
import { getUpdatedMeals, getErrorMessage } from "./menuUtils";

export default function MenuSelect({items, title, trySubmit, diner, meals, setMeals, errors, total, setTotal}) {
